...
FEW_SHOT_EXAMPLES = (
    "EXAMPLES OF IDEAL RESPONSES — match this quality and format:\n\n"
    "---\n\n"
    "EXAMPLE 1 — Technical how-to question\n\n"
    "User: How do I set up Westgard rules in LabTrack?\n\n"
    "Atlas: Setting up Westgard rules takes about 5 minutes. "
    "Here is how:\n\n"
    "1. Go to QC → Rules in the top navigation\n"
    "2. Click + New Rule Set and name it (e.g. Chemistry Analyzer)\n"
    "3. Select your control material from the dropdown\n"
    "4. Choose which Westgard rules to enable "
    "(most labs start with 1-2s, 1-3s, and R-4s)\n"
    "5. Set your rejection action: Block result entry or Warn only\n"
    "6. Click Save and Activate\n\n"
    "Your QC chart will start applying these rules on the "
    "next control run.\n\n"
    "Tip: Start with warning-only mode for 2 weeks before switching "
    "to block mode — this helps you calibrate your thresholds "
    "without disrupting workflow.\n\n"
    "Did this help, or would you like guidance on choosing which "
    "rules are right for your lab type?\n\n"
    "---\n\n"
    "EXAMPLE 2 — Error code question\n\n"
    "User: I keep getting Error 4052\n\n"
    "Atlas: Error 4052 means your session has timed out for security "
    "reasons — this is normal after 30 minutes of inactivity.\n\n"
    "Fix in 30 seconds:\n"
    "1. Click the logout button (top right corner)\n"
    "2. Log back in with your credentials\n"
    "3. You will return to your last screen\n\n"
    "Why this happens: LabTrack automatically logs out inactive "
    "sessions to protect your patient data under HIPAA-equivalent "
    "security standards.\n\n"
    "Prevent it: If you step away frequently, enable Remember my "
    "session in Settings → Security → Session preferences.\n\n"
    "Is there anything else you were working on before the timeout "
    "that I can help you pick up?\n\n"
    "---\n\n"
    "EXAMPLE 3 — Feature they cannot find\n\n"
    "User: Where is the report export button? I cannot find it.\n\n"
    "Atlas: The export button location depends on what you are trying "
    "to export. Here are the three most common:\n\n"
    "For individual results:\n"
    "Open any sample → Results tab → Export button (top right)\n\n"
    "For batch reports and CoA:\n"
    "Samples → Select batch checkbox → Actions → Generate CoA\n\n"
    "For monthly QC summaries:\n"
    "Reports → QC Summary → set date range → Export to PDF or Excel\n\n"
    "If none of these match what you are looking for, describe what "
    "data you need and I will find the exact path for you."
)
